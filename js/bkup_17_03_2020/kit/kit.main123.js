...
function getLipColors(){
    return JSON.parse(localStorage.getItem('lip_colors')) || [];
}
    window.makeoverKit = function (params) {
        ...
        app.config = {
            ...
            canvasH: 300,
            waterMark: true,
            waterMarkText1: 'Make Over', //string
            waterMarkText2: ' Developed by Ramscreative',
            ...
            lipglowColors: ["#DB7781", "#807E88", "#B0ACA2"],//getLipColors(),
            liplinerColors: ["#DB7781", "#807E88", "#B0ACA2"],//getLipColors(),
            //eye
        ...
        function resetValue() {
            window.lipstickColor = 'rgba(0,0,0,0)', window.lipstickAmount = 0.5;
            window.lipglossColor = 'rgba(0,0,0,0)', window.lipglossAmount = 0.2;
            window.liplinerColor = 'rgba(0,0,0,0)', window.liplinerAmount = 0.5;

            window.eyeshadowColor = 'rgba(0,0,0,0)', window.eyeshadowAmount = 0.5, window.eyeshadowSize = 20;
            window.eyelinerColor = 'rgba(0,0,0,0)', window.eyelinerAmount = 0.5, window.eyelinerSize = 10;
            window.eyebrowColor = 'rgba(0,0,0,0)', window.eyebowAmount = 0.5, window.eyebrowSize = 2;

            window.facefoundationColor = 'rgba(0,0,0,0)', window.facefoundationAmount = 0.5;
            window.faceconcealerColor = 'rgba(0,0,0,0)', window.faceconcealerAmount = 0.5;
            window.faceblushColor = 'rgba(0,0,0,0)', window.faceblushAmount = 0.5;
        }
